...
## Table of Contents
- [Sekiro PopTracker](#sekiro-poptracker)
    - [Overview](#overview)
...
1. Download the [PopTracker][PT] from the official Website.
...
1. In the top left of the PopTracker, press the grey `AP` symbol.
2. This opens a window where you have to enter your AP room's address and port. (e.g. `archipelago.gg:12345`).
3. Now enter your slotname that you've set in your .yaml.
...
| Color  | Meaning |
|--------|---------|
| Red    | Checks are not currently accessible. |
| Green  | Checks are accessible. |
...
**Questions about the Sekiro Archipelago mod?**

Please use the Archipelago Discord Server [AP After Dark][AP-AD].
There you find the [Sekiro AP Channel][S-AP].

**Questions or bugs about this PopTracker pack?**
...
- [Sekiro AP-Mod Team][S-AP]: Thanks for providing valuable information, item lists, testing support and assistance throughout development.





[¹]: https://archipelago.miraheze.org/wiki/PopTracker#:~:text=it%2E-,PopTracker,packs%2E
[PT]: https://poptracker.github.io/
[SPT]: https://github.com/vonTungsten/Sekiro-Poptracker/releases
[AP-AD]: https://discord.gg/CqxTjXbrQ
[S-AP]: https://discord.com/channels/1085716850370957462/1530388679074513037
[I]: https://github.com/vonTungsten/Sekiro-Poptracker/issues
